    ...
    <Section id="sobre" className="py-24 relative">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
           ...
           viewport={{ once: true, margin: "-100px" }}
        >
          <GlassCard className="p-8 md:p-12 border-l-4 border-primary/50 relative mt-8 md:mt-0">
            ...
            <h3 className="text-2xl font-bold text-white mb-4 mt-2 pl-8 md:pl-0">Nossa Missão</h3>
